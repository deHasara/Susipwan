...
$sql = "select * from members where member_id= '".$_SESSION['uid']."' and member_password='".md5($oldpassword )."'";
echo $sql;
$q = $conn->query($sql);
if($q->num_rows>0)
{

$sql = "update members set  member_password = '".md5($newpassword)."' WHERE member_id = '".$_SESSION['uid']."'";
$r = $conn->query($sql);
