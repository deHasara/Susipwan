...
$branch = mysqli_real_escape_string($conn,$_POST['branch']);
 ...
 $q1 = $conn->query("INSERT INTO  (sname,joindate,contact,about,emailid,branch_id,balance,fees) VALUES ('$sname','$joindate','$contact','$about','$emailid','$branch','$balance','$fees')") ;
 ...
 $conn->query("INSERT INTO  fees_transaction (stdid,paid,submitdate,transcation_remark) VALUES ('$sid','$advancefees','$joindate','$remark')") ;
   ...
   echo '<script type="text/javascript">window.location=".php?act=1";</script>';

 }else
  if($_POST['action']=="update")
 {
 $id = mysqli_real_escape_string($conn,$_POST['id']);
 $sql = $conn->query("UPDATE    SET  branch_id  = '$branch', sname  = '$sname', contact = '$contact', about  = '$about', emailid = '$emailid'  WHERE  id  = '$id'");

   echo '<script type="text/javascript">window.location=".php?act=2";</script>';
 }
...
$conn->query("UPDATE   set delete_status = '1'  WHERE id='".$_GET['id']."'");
header("location: .php?act=3");
...
$sqlEdit = $conn->query("SELECT * FROM  WHERE id='".$id."'");
if($sqlEdit->num_rows)
{
		...
		?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<form action=".php" method="post" id="signupForm1" class="form-horizontal">
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="contact" name="contact" value="<?php echo $contact;?>" maxlength="10" minLength="10"/>
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student inner join branch on student.branch =branch.id WHERE student.delete_status='0' and branch.delete_status='0'";
									$q = $conn->query($sql);
									...
									echo '<tr '.(($r['balance']>0)?'class="danger"':'').'>
											...
											<a href="student1.php" class="btn btn-primary btn-sm" role="button">View Only</a>
